...
(
  ...
  CONSTRAINT dishes_in_restau_Restuarants_rid_fk
  FOREIGN KEY (rid) REFERENCES restuarants (id)
)
  ENGINE = InnoDB;
...
(
  ...
  CONSTRAINT cuisine_in_restau_restuarants_rid_fk
  FOREIGN KEY (rid) REFERENCES restuarants (id)
)
  ENGINE = InnoDB;
...
(
  ...
  CONSTRAINT ratings_restuarants_rid_fk
  FOREIGN KEY (rid) REFERENCES restuarants (id)
)
  ENGINE = InnoDB;
