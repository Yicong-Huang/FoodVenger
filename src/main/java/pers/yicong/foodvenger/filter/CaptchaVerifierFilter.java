...
public class CaptchaVerifierFilter extends OncePerRequestFilter {
    ...
    public void doFilterInternal(HttpServletRequest req, HttpServletResponse res,
        ...
        System.out.println("challenge: " + captchaCaptureFilter.getRecaptcha_challenge());
        System.out.println("response: " + captchaCaptureFilter.getRecaptcha_response());
        System.out.println("remoteAddr: " + captchaCaptureFilter.getRemoteAddr());
